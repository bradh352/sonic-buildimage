...
$(SONIC_YANG_MGMT_PY3)_DEBS_DEPENDS = $(LIBYANG3)
$(SONIC_YANG_MGMT_PY3)_PYTHON_WHEELS += $(LIBYANG_PY3)
$(SONIC_YANG_MGMT_PY3)_DEPENDS =  $(SONIC_YANG_MODELS_PY3) $(LIBYANG_PY3)
$(SONIC_YANG_MGMT_PY3)_RDEPENDS = $(SONIC_YANG_MODELS_PY3) $(LIBYANG_PY3)
